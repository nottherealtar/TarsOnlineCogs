...
def create_welcome(user:disnake.Member, user_avatar, join_pos):
    ...
    WELCOME_TEXT = "Welcome to TarsOnlineCafe,"
    NAME_TEXT = user.name
    INFO_TEXT = [
        ...
        f"Activity:",
    ] + textwrap.wrap(user.activity.name if user.activity else "NULL", 25)
...
channel_name = "welcome"  # Replace with the name of your target channel

# Find the channel by name
target_channel = discord.utils.get(member.guild.text_channels, name=channel_name)
